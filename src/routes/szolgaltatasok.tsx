...
const SERVICES = [
  {
    ...
    audience:
      "Kis- és középvállalkozásoknak, akik szeretnék maguk is szerkeszteni az oldalt.",
    includes: [
  ...
  },
  {
    ...
    audience:
      "Szolgáltató vállalkozásoknak, akik professzionális bemutatkozó oldalt szeretnének.",
    includes: [
      "5–10 aloldal",
  ...
  },
  {
    ...
    audience:
      "Meglévő oldalak modernizálásához, akik gyorsabb és letisztultabb megjelenést szeretnének.",
    includes: [
      "UX audit",
      "Új design rendszer",
      "Tartalom-migráció",
  ...
  },
  {
    ...
    audience:
      "WordPress alapú oldalak tulajdonosainak, akiknek fontos a biztonság és a folytonosság.",
    includes: [
  ...
  },
  {
    ...
    audience:
      "Vállalkozásoknak, akik szeretnének több organikus látogatót és jobb Core Web Vitals-t.",
    includes: [
      "Technikai SEO audit",
      "Sebességjavítás",
      "Meta és sémák",
  ...
  },
  {
    ...
    audience:
      "Komplexebb üzleti folyamatokhoz, ahol egy WordPress már nem elég.",
    includes: [
      "Egyedi UI/UX",
      "Backend integrációk",
      "Autentikáció",
