...
function BlogIndexPage() {
  ...
  useEffect(() => {
    ...
    async function loadPosts() {
      ...
      if (error) {
        setErrorMessage(
          "A blogbejegyzések átmenetileg nem tölthetők be.",
        );
        setLoading(false);
        return;
      }
      ...
      <section className="relative overflow-hidden border-b bg-secondary/35 py-16 md:py-24">
        ...
        <div className="container-page relative">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-ink-soft md:text-lg">
            Gyakorlati útmutatók weboldalakról,
            online jelenlétről, teljesítményről és
            digitális üzleti megoldásokról.
          </p>
        </div>
      </section>
